                                                  ...
                                                  <tbody>
                                                    ...
                                                    <form action="" id="blockunblock" method="POST">
                                                      ...
                                                      <td>
                                                        ...
                                                        <div><?php echo $values->Last_name;?></div>
                                                        <div><?php echo $values->Ratings;?></div>
                                                        <!-- <div><?php echo $values->isfavourite;?></div> -->
                                                        <!-- <div></div> -->
                                                        <input type="" name="targetid" id="targetid" value="<?php echo $values->Ratingto;?>">
                                                        <input type="" name="userid" id="userid" value="<?php echo $values->Ratingfrom;?>">
                                                      </td>
