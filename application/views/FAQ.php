          ...
          <div class="btn-group d-flex buttons">
            <ul class="nav nav-pills" role="tablist">
              <li class="nav-item" id="tab1">
                <a  class="btn customer nav-link tb-li border-bottom active" data-bs-toggle="pill" href="#home125" aria-current="page">FOR CUSTOMER</a>
              </li>
               <li class="nav-item" id="tab2">
                <!-- <a href="#" class="btn active customer" aria-current="page">FOR CUSTOMER</a> -->
                 <a href="#ok" class="btn service nav-link tb-li border-bottom" data-bs-toggle="pill">FOR SERVICE PROVIDER</a>
              </li>
            </ul>
...
<div class="tab-content">
  <div id="home125" class="container tab-pane active">
          <div>
            <a href="" data-bs-toggle="collapse" data-bs-target="#demo1" ><img src="http://localhost/Home_DB/assets/images/faq/btn-2.png" id="for-customer" class="btn-2 btn" alt=""></a>
          ...
          <div class="text-1 text-sm-start" id="demo1">
          ...
          <div>
            <a href="" data-bs-toggle="collapse" data-bs-target="#demo2" ><img src="http://localhost/Home_DB/assets/images/faq/btn-2.png" id="for-customer" class="btn-2 btn" alt=""></a>
          
            <span class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nisl nunc, iaculis mattis tellus imperdiet velit?</span>
          </div><br>
          <div class="text-1 text-sm-start" id="demo2">
            <span >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id diam tincidunt, fringilla vitae, dapibus velit. Vivamus id <br> tortor rhoncus, efficitur at, suscipit tortor. Integer fermentum convallis eros semper. Ut non imperdiet velit. Praesent <br> eu dui lacus porta eleifend eget quis dui. Integer tempus massa gravida tincidunt. Fusce libero tristique, euismod nisi <br> vel, luctus urna. Interdum malesuada fames ante ipsum primis faucibus. Donec et placerat arcu. Suspendisse lacinia <br> tristique massa. Etiam justo, scelerisque arcu eu, sodales tempor eros. Aliquam efficitur pretium urna, sit amet congue <br> risus malesuada rutrum. Donec id vel velit ullamcorper accumsan ut eget nisl. Fusce viverra commodo lacus, sit amet <br> facilisis leo luctus dictum.</span>
          </div>
          <div>
            <a href="" data-bs-toggle="collapse" data-bs-target="#demo3" ><img src="http://localhost/Home_DB/assets/images/faq/btn-2.png" id="for-customer" class="btn-2 btn" alt=""></a>
          
            <span class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nisl nunc, iaculis mattis tellus imperdiet velit?</span>
          </div><br>
          <div class="text-1 text-sm-start" id="demo3">
            <span >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id diam tincidunt, fringilla vitae, dapibus velit. Vivamus id <br> tortor rhoncus, efficitur at, suscipit tortor. Integer fermentum convallis eros semper. Ut non imperdiet velit. Praesent <br> eu dui lacus porta eleifend eget quis dui. Integer tempus massa gravida tincidunt. Fusce libero tristique, euismod nisi <br> vel, luctus urna. Interdum malesuada fames ante ipsum primis faucibus. Donec et placerat arcu. Suspendisse lacinia <br> tristique massa. Etiam justo, scelerisque arcu eu, sodales tempor eros. Aliquam efficitur pretium urna, sit amet congue <br> risus malesuada rutrum. Donec id vel velit ullamcorper accumsan ut eget nisl. Fusce viverra commodo lacus, sit amet <br> facilisis leo luctus dictum.</span>
          </div>
          <div>
            <a href="" data-bs-toggle="collapse" data-bs-target="#demo4" ><img src="http://localhost/Home_DB/assets/images/faq/btn-2.png" id="for-customer" class="btn-2 btn" alt=""></a>
          
            <span class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nisl nunc, iaculis mattis tellus imperdiet velit?</span>
          </div><br>
          <div class="text-1 text-sm-start" id="demo4">
            <span >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id diam tincidunt, fringilla vitae, dapibus velit. Vivamus id <br> tortor rhoncus, efficitur at, suscipit tortor. Integer fermentum convallis eros semper. Ut non imperdiet velit. Praesent <br> eu dui lacus porta eleifend eget quis dui. Integer tempus massa gravida tincidunt. Fusce libero tristique, euismod nisi <br> vel, luctus urna. Interdum malesuada fames ante ipsum primis faucibus. Donec et placerat arcu. Suspendisse lacinia <br> tristique massa. Etiam justo, scelerisque arcu eu, sodales tempor eros. Aliquam efficitur pretium urna, sit amet congue <br> risus malesuada rutrum. Donec id vel velit ullamcorper accumsan ut eget nisl. Fusce viverra commodo lacus, sit amet <br> facilisis leo luctus dictum.</span>
          </div>
                        ...
                        <div id="ok" class="container tab-pane fade"><br>
                                                            ...
                                                            <div class="row ">
                                                                ...
                                                                <div class="container mt-3">
                                                                        ...
                                                                        <div>
            <a href="" data-bs-toggle="collapse" data-bs-target="#demo5" ><img src="http://localhost/Home_DB/assets/images/faq/btn-2.png" id="for-customer" class="btn-2 btn" alt=""></a>
          
            <span class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nisl nunc, iaculis mattis tellus imperdiet velit?</span>
          </div><br>
          <div class="text-1 text-sm-start" id="demo5">
            <span >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id diam tincidunt, fringilla vitae, dapibus velit. Vivamus id <br> tortor rhoncus, efficitur at, suscipit tortor. Integer fermentum convallis eros semper. Ut non imperdiet velit. Praesent <br> eu dui lacus porta eleifend eget quis dui. Integer tempus massa gravida tincidunt. Fusce libero tristique, euismod nisi <br> vel, luctus urna. Interdum malesuada fames ante ipsum primis faucibus. Donec et placerat arcu. Suspendisse lacinia <br> tristique massa. Etiam justo, scelerisque arcu eu, sodales tempor eros. Aliquam efficitur pretium urna, sit amet congue <br> risus malesuada rutrum. Donec id vel velit ullamcorper accumsan ut eget nisl. Fusce viverra commodo lacus, sit amet <br> facilisis leo luctus dictum.</span>
          </div>
          <div>
            <a href="" data-bs-toggle="collapse" data-bs-target="#demo6" ><img src="http://localhost/Home_DB/assets/images/faq/btn-2.png" id="for-customer" class="btn-2 btn" alt=""></a>
          
            <span class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nisl nunc, iaculis mattis tellus imperdiet velit?</span>
          </div><br>
          <div class="text-1 text-sm-start" id="demo6">
            <span >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id diam tincidunt, fringilla vitae, dapibus velit. Vivamus id <br> tortor rhoncus, efficitur at, suscipit tortor. Integer fermentum convallis eros semper. Ut non imperdiet velit. Praesent <br> eu dui lacus porta eleifend eget quis dui. Integer tempus massa gravida tincidunt. Fusce libero tristique, euismod nisi <br> vel, luctus urna. Interdum malesuada fames ante ipsum primis faucibus. Donec et placerat arcu. Suspendisse lacinia <br> tristique massa. Etiam justo, scelerisque arcu eu, sodales tempor eros. Aliquam efficitur pretium urna, sit amet congue <br> risus malesuada rutrum. Donec id vel velit ullamcorper accumsan ut eget nisl. Fusce viverra commodo lacus, sit amet <br> facilisis leo luctus dictum.</span>
          </div>
          <div>
            <a href="" data-bs-toggle="collapse" data-bs-target="#demo7" ><img src="http://localhost/Home_DB/assets/images/faq/btn-2.png" id="for-customer" class="btn-2 btn" alt=""></a>
          
            <span class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nisl nunc, iaculis mattis tellus imperdiet velit?</span>
          </div><br>
          <div class="text-1 text-sm-start" id="demo7">
            <span >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id diam tincidunt, fringilla vitae, dapibus velit. Vivamus id <br> tortor rhoncus, efficitur at, suscipit tortor. Integer fermentum convallis eros semper. Ut non imperdiet velit. Praesent <br> eu dui lacus porta eleifend eget quis dui. Integer tempus massa gravida tincidunt. Fusce libero tristique, euismod nisi <br> vel, luctus urna. Interdum malesuada fames ante ipsum primis faucibus. Donec et placerat arcu. Suspendisse lacinia <br> tristique massa. Etiam justo, scelerisque arcu eu, sodales tempor eros. Aliquam efficitur pretium urna, sit amet congue <br> risus malesuada rutrum. Donec id vel velit ullamcorper accumsan ut eget nisl. Fusce viverra commodo lacus, sit amet <br> facilisis leo luctus dictum.</span>
          </div>
