...
<link href="https://fonts.googleapis.com/css2?family=Roboto&family=Work+Sans&display=swap" rel="stylesheet">
  ...
  <body>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="#">welcome<?php echo $this->getSession('Userid');?></a></li>
                  <li><a class="dropdown-item" href="#">my settings</a></li>
                   <div class="nav nav-pills " id="v-pills-tab" role="tablist">
                     <div class="nav-link" id="v-pills-helo-tab" data-bs-toggle="pill" data-bs-target="#v-pills-helo" type="button" role="tab" aria-controls="v-pills-helo" aria-selected="false">Profile</div>
                   </div>
        ...
        <div class="align-items-start hy">
            ...
            <div class="container-fluid ver-nav navbar navbar-collapse navbar-nav">
                <div class="nav d-grid col-lg-12 nav-pills me-5 " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <div class="nav-link item1 home border-bottom active " id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Home</div>
                    <div class="nav-link item1  border-bottom" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Profile</div>
                    <div class="nav-link item1 border-bottom" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">Messages</div>
    ...
    <!-- <p><?php print_r($_SESSION['servicehistory']); ?></p>   -->
                                                ...
                                                <table id="imp" class="table table-responsive">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr data-bs-toggle="modal" data-bs-target="#modalcontainer<?php echo $values->ServiceRequestId;?>">
                                                      ...
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""><?php $dateArray = explode(" ", $values->ServiceStartDate); print_r($dateArray[0]);?></div>
                                                        <div><img src="images/calendar.png" alt=""><?php $dateArray = explode(" ", $values->ServiceStartDate); print_r($dateArray[1]);?></div>
                                                      </td>
                                                      <td>
                                                      
                                                        <span><img class="img1" src="images/hat.png" alt=""></span> 
                                                        <!-- <span class="txt" >  Lyum Watson</span>  -->
                                                        <div class="txt1"><img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/star2.png" alt=""><?php echo $values->First_name;?>&nbsp<?php echo $values->Last_name;?> </div>
                                                      </td>
                                                        <td class="txt2">
                                                      ...
                                                      <td class="justify-content-center">
                                                        ...
                                                        <button type="submit" name="login" data-bs-toggle="modal" data-bs-target="#modal1<?php echo $values->ServiceRequestId;?>" id="login" class="btn btn1 border">cancel</button>
                                                      </td>
                                                    </tr>
                                                         ...
                                                         <div class="modal-body">
                                                          <form action="<?php echo BASEURL; ?>/functions/userlogin" method="POST">
                                                            <div class="col-md-10">
                                                                    ...
                                                                    <small><b><?php $dateArray = explode(" ", $values->ServiceStartDate); print_r($dateArray[1]);?></b></small><br>
                                                                    <small>Duration:<?php echo $values->ServiceHours;?></small>
                                                                ...
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <small>Net Amount: <?php echo $values->TotalCost;?></small>
                                                                </div>
                                                                <hr class="line-1">
                                                                ...
                                                                <div>
                                                                   ...
                                                                   <button type="submit" name="login" id="login" class="btn btn1 border">cancel</button>
                                                                 </div>
                                                        ...
                                                        <div class="modal-content justify-content-center">
                                                         ...
                                                         <div class="modal-body">
                                                          <form action="<?php echo BASEURL; ?>/functions/reschedule" method="POST">
                                                            <div class="col-md-10">
                                                               <input type="" name="cancelid1" value="<?php echo $values->ServiceRequestId;?>">
                                                               <input type="" name="proid1" value="<?php echo $values->Serviceproviderid;?>">
                                                                    ...
                                                                    <select class="form-select-sm op" id="time" name="time1"
                                                                        ...
                                                                        <option selected value="<?php $dateArray = explode(" ", $values->ServiceStartDate); print_r($dateArray[0]);?>"><?php echo $values->StartTime;?></option>
                                                                ...
                                                                <div>
                                                                   <button type="submit" name="reschedule" id="login" class="btn btn1 border">Reschadule</button>
                                                                 </div>
                                                        ...
                                                        <div class="modal-content justify-content-center">
                                                         ...
                                                         <div class="modal-body">
                                                          <form action="<?php echo BASEURL; ?>/functions/Cancel1" method="POST">
                                                            <div class="col-md-10">
                                                              <input type="" name="cancelid" value="<?php echo $values->ServiceRequestId;?>">
                                                              <input type="" name="cancelproid" value="<?php echo $values->Serviceproviderid;?>">
                                                              ...
                                                              <p>Why you want to cancel tha service request?</p>
                                                                ...
                                                                <div>
                                                                   <button type="submit" name="Cancel1" id="login" class="btn btn1 border">Cancel now</button>
                                                                 </div>
                                              ...
                                              <div class="row float-end sh2 table-2">
                                                <table class="table table-responsive">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr data-bs-toggle="modal" data-bs-target="#shistory<?php echo $values->ServiceRequestId;?>">
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> <?php $dateArray = explode(" ", $values->ServiceStartDate); print_r($dateArray[0]);?></div>
                                                        <div><?php $dateArray = explode(" ", $values->ServiceStartDate); print_r($dateArray[1]);?></div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> 
                                                        <span class="txt" ><?php echo $values->First_name;?><?php echo $values->Last_name;?></span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/star2.png" alt="">  4 </div></td>
                                                        <td class="txt2">
                                                     ...
                                                     <div class="modal fade" id="shistory<?php echo $values->ServiceRequestId;?>" tabindex="-1" aria-labelledby="modalcontainer" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content justify-content-center">
                                                         <div class="modal-header">
                                                         ...
                                                         <div class="modal-body">
                                                          <form id="ratesp11" method="post">
                                                            <div class="col-md-10">
                                                              <input type="" id="serviceid1" name="serviceid1" value="<?php echo $values->ServiceRequestId;?>">
                                                              <input type="number" id="ratingtosp" name="ratingtosp" value="<?php echo $values->Serviceproviderid;?>">
                                                              <input type="" id="ratingfrom" name="ratingfrom" value="<?php echo $values->UserId;?>">
                                                              <input type="" id="commentsp" name="commentsp" value=" ">
                                                              <input type="" name="value5" value="" id="value5">
                                                                ...
                                                                </fieldset>On time arrival
                                                                  </div>

                                                                <div>
                                                                   <button type="button" onclick="ok()" name="save" id="save55" class="btn btn1 border">Submit</button>
                                                                 </div>
                                              ...
                                              <div class="row float-end sh2">
                                                <table class="table table-responsive">
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 31/03/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> 
                                                        <span class="txt" >  Lyum Watson</span> 
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 15/03/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"> <img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/y-star.png" alt=""> <img src="images/star2.png" alt=""> 4 </div></td>
                                                        <td class="txt2">
                                                        €63
                                                      </td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 10/03/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 28/02/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 15/02/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 11/02/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 31/01/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 19/01/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 05/01/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                        <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <div> <img src="images/calendar.png" alt=""> 01/01/2018 </div>
                                                        <div>12:00 - 18:00</div>
                                                      </td>
                                                      <td> <span><img class="img1" src="images/hat.png" alt=""></span> <span class="txt" >  Lyum Watson</span> 
                                                      <div class="txt1"><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/y-star.png" alt=""><img src="images/star2.png" alt=""> 4 </div></td>
                                                        ...
                                                        <div class="modal-content justify-content-center">
                                                         ...
                                                         <div class="modal-body">
                                                          <div class="container border main1" id="address-form" >
                                                                  <form class="row g-3"  method="post" id="Add-form2">
                                                        ...
                                                        <div class="modal-content justify-content-center">
                                                         ...
                                                         <div class="modal-body">
                                                          <div class="container border main1" id="address-form" >
                                                                  <form class="row g-3"  method="post" id="Add-form2">
                                                                      <!-- <input  type="hidden" id="Userid2" value="<?php echo $this->getSession('Userid');?>" name="Userid2"> -->
                                                                      <input type="" value="<?php echo $values->AddressId;?>" name="Addid3" id="Addid3">
                                                                      <p>are you sure you want to delet this?</p>
                                                                      <div class="col-12">
                                                                        <button type="button" onclick="helo55()" id="Delete" name="Delete" class="btn btn1">Delete</button>
                                                                        <!-- <button type="cancel" id="cancel" class="btn submit1">Cancel</button> -->
                                                                      </div>
                                                                    </form>
                                                              </div>
