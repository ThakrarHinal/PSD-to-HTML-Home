<!doctype html>
  ...
  <link rel="stylesheet" href="http://localhost/Home_DB/assets/css/header.css">
    ...
    <body>
      <nav class="navbar navbar-expand-lg navbar-light Rectangle sticky-top">
          <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo BASEURL; ?>/functions/Home"><img src="http://localhost/Home_DB/assets/images/About/logo-small.png" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link border br text-center" href="<?php echo BASEURL; ?>/functions/Prices">Prices & services</a>
                </li>
...
<!-- if ("SELECT street FROM Address WHERE Userid = '$Userid'") {
                    // code...
                     $row = $this->fetch();
                        $street = $row->street;
                        return ['street' => $street];
                     $this->setSession("street", "$street");
                                     // $res = $this->getSession("street"); // echo $res;   
                } -->